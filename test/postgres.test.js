...
// CamelCase to Snake case conversion and back
...
var caseConverter = {
  toColumnName: snakeToCamelCase,
  fromColumnName: camelToSnakeCase
}
...
describe('postgres', function () {
  before({}, function (done) {
    si2.use(require('..'), Config)
    si2.ready(function () {
      si2.use(require('seneca-store-query'))
      si2.ready(done)
    })
  })

  beforeEach(clearDb(si2))
  beforeEach(createEntities(si2, 'foo', [{
    id$: 'foo1',
    p1: 'v1'
  }, {
    id$: 'foo2',
